...
public class LevelFactory {
    ...
    public static Map<Integer, GameLevel> createAndAddLevels(){
        ...
        GameLevel level5 = new GameLevel();
        ...
        GameLevel level6 = new GameLevel();
        ...
        GameLevel level7 = new GameLevel();
        ...
        GameLevel level8 = new GameLevel();
        ...
        GameLevel level9 = new GameLevel();
        ...
        GameLevel level10 = new GameLevel();
