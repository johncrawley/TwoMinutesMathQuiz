...
public interface ScorePreferences {
    ...
    void saveDailyHighScore(int score, String timerLength, String difficulty);
    int getHighScore(String timerLength, String difficulty);
    int getDailyHighScore(String timerLength, String difficulty);
    void saveDate(String dateStr);
    String getSavedDate();
}
